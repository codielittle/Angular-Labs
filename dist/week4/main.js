...
module.exports = "<h1>Account Page</h1>\nUsername: {{userObject.username}}\n<br>\nUser DOB: {{userObject.birthDate}}\n<br>\nUser Age: {{userObject.age}}\n"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.loginUser = function (event) {
        this.http.post('login', { username: this.username, password: this.password, }).subscribe(function (res) {
            console.log("test");
            console.log(res);
        });
...
module.exports = __webpack_require__(/*! /Users/codielittle/Desktop/Workshop5/Angular-Labs/src/main.ts */"./src/main.ts");
